...
export const demoContent = {
  ...
  investigation: {
    ...
    historicalResolutionLabel: "Historical investigation:",
    similarityLabel: "Similarity",
    noteLabel: "Note:",
    historicalNote:
      "Similarity to historical investigations does not imply the same underlying cause. Differences in software versions, hardware configurations, and operating environments may require a different investigation path.",
    languageEyebrow: "",
    languageTitle: "",
    prohibitedLabel: "",
    prohibitedTerms: [],
  ...
  sensorFae: {
    ...
    resultTitle: "Prepare Investigation Findings",
    resultStatusLabel: "Result Status",
    resultSummaryLabel: "IR Summary (Demo)",
    resultSummaryPrefix: "A related historical pattern was observed in ",
    resultSummarySuffix:
      ". The USB 3.0 bus reset observed during high-bandwidth operation is consistent with a previously investigated EMI-sensitive cable pattern. Current evidence does not indicate a firmware or sensor hardware defect. Additional validation using a shielded cable is recommended.",
    ...
    readyDescription:
      "The IR, LL, and supporting candidate analysis will be returned with the EGP response package to the OEM Tier 2 / Tier 3 engineering team for further engineering review.",
