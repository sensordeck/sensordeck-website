...
one shared runtime governance infrastructure`,
  ...
  architecture: {
    ...
    description:
      "Atlas Runtime Investigation™ serves robot OEMs. Atlas Runtime Sensor Governance™ serves sensor manufacturers. EGP — Sensor–OEM Engagement Package connects both organizations through structured runtime evidence and clearly defined investigation boundaries.",
  ...
  productA: {
    ...
    valuePoints: [
      ...
      "Use Historical RGA Recall instead of repeating prior work",
      "Contribute approved, closed, unidentifiable IR and LL records to Atlas Shared Unidentifiable Vault",
    ],
  ...
  productB: {
    ...
    valuePoints: [
      ...
      "Create an EGP — Sensor–OEM Engagement Package and collaborate with Sensor FAE",
      "Close REF tickets and preserve investigation knowledge in Atlas Shared Unidentifiable Vault",
    ],
    ...
    lifecycle: [
      ...
      "Close OEM REF Ticket and Preserve Atlas Shared Unidentifiable Vault Assets",
    ],
  },

  collaborationBridge: {
    eyebrow: "Shared Collaboration Bridge",
    title: "EGP — Sensor–OEM Engagement Package Connects OEMs and Sensor Manufacturers",
    description:
      "EGP — Sensor–OEM Engagement Package is scoped to the current investigation. The OEM retains control of its private EP and authorizes what enters the EGP. Only approved, closed, unidentifiable IR and LL records may enter the Atlas Shared Unidentifiable Vault.",
