...
一个共享运行时治理基础设施`,
  ...
  heroSubtitle:
    "Atlas 将机器人制造商与传感器制造商连接到同一套运行时治理体系，共享运行时证据、调查资产与组织知识，形成持续积累、持续协同、持续复用的运行时治理闭环。",

 heroStatement:
  "共同构建机器人行业持续运行的治理基础设施。",
  architecture: {
  ...
  productA: {
    ...
    audience: "传感器制造商",
    description:
      "定义传感器运行的‘事后’标准，跨OEM、跨场景实时监控传感器运行时健康度。通过智能协同调查包（EGP）驱动FAE高效作业，自动归档调查报告（IR）与经验教训（LL）。我们将离散的‘事故’转化为可复用的‘知识’（Historical RGA），帮助传感器厂商在部署后持续迭代，让运维经验成为下一代产品的设计输入。 ",
