...
const homeContent = {
  ...
  sectionDescriptions: {
    categoryDefinition: "机器人行业已经跨越研发时代，进入部署运营时代。\n\n过去十年，机器人行业持续投入更好的传感器、更强的算力、更先进的 AI、更成熟的软件平台，成功让机器人走出实验室，进入医院、工厂、酒店、物流和矿山等真实场景。\n\n今天，越来越多企业面对的挑战，已经不再是如何研发机器人，而是如何让已经部署出去的机器人长期稳定运行。",
