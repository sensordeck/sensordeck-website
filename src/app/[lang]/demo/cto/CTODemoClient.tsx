  ...
  return (
    <div className="bg-white font-sans text-ink">
        ...
        <Section className="border-b border-border bg-white py-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
              ...
              <span className="text-sm text-muted">{content.cto.dashboardTitle}</span>
            </div>
            <div className="flex flex-wrap items-center gap-3 sm:gap-4">
              <span className="text-xs text-muted">Dr. Zhou (CTO)</span>
              <span className="border border-border px-2 py-1 text-[10px] font-semibold uppercase tracking-wider text-muted">{content.cto.dashboardRole}
        ...
        <Section className="bg-surface py-4">
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex w-full flex-col items-start gap-2 sm:w-auto sm:flex-row sm:items-center">
              <span className="text-xs text-muted">{content.cto.timeRangeLabel}</span>
              <div className="grid w-full grid-cols-3 border border-border bg-white sm:flex sm:w-auto">
                {(["30", "90", "180"] as const).map((range) =>
                <button
                  className={`min-h-11 px-2 py-2 text-xs font-semibold sm:px-4 ${
                  timeRange === range ?
            ...
            <div className="flex w-full flex-col items-start gap-2 sm:w-auto sm:flex-row sm:items-center">
              <span className="text-xs text-muted">{content.cto.roiModelLabel}</span>
              <div className="grid w-full grid-cols-3 border border-border bg-white sm:flex sm:w-auto">
                {(["conservative", "expected", "actual"] as const).map((mode) =>
                <button
                  className={`min-h-11 px-2 py-2 text-xs font-semibold capitalize sm:px-4 ${
                  roiMode === mode ?
                  "bg-atlas-blue text-white" :
                  "bg-white text-ink hover:bg-surface"}`
                  }
        ...
        <Section className="bg-white">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="border border-border bg-surface p-6">
              <p className="text-xs text-muted">{content.cto.openRefsLabel}</p>
              <p className="mt-2 text-4xl font-semibold text-ink">{kpis.open_ref}</p>
              <p className="mt-1 text-xs text-green-700">{content.cto.openRefsTrend}</p>
            </div>
            <div className="border border-border bg-surface p-6">
              <p className="text-xs text-muted">{content.cto.safetyRefsLabel}</p>
              <p className="mt-2 text-4xl font-semibold text-ink">{kpis.safety_relevant_ref}</p>
              <p className="mt-1 text-xs text-muted">{content.cto.safetyRefsNote}</p>
            </div>
            <div className="border border-border bg-surface p-6">
              <p className="text-xs text-muted">{content.cto.firstEvidencePackLabel}</p>
              <p className="mt-2 text-4xl font-semibold text-ink">{kpis.median_time_to_first_ep}m</p>
              <p className="mt-1 text-xs text-green-700">{content.cto.firstEvidencePackTrend}</p>
            </div>
            <div className="border border-border bg-surface p-6">
              <p className="text-xs text-muted">{content.cto.closureLabel}</p>
              <p className="mt-2 text-4xl font-semibold text-ink">{kpis.median_time_to_closure}d</p>
              <p className="mt-1 text-xs text-green-700">{content.cto.closureTrend}</p>
            </div>
          </div>
        </Section>
        ...
        <Section className="bg-surface">
          ...
          <h2 className="mt-4 text-2xl font-semibold tracking-tight text-ink">{content.cto.memoryTitle}

          </h2>
          <div className="mt-8 grid gap-4 lg:grid-cols-3">
            <div className="border border-border bg-white p-6">
              <p className="text-xs text-muted">{content.cto.reuseRateLabel}</p>
            ...
            <div className="border border-border bg-white p-6">
              <p className="text-xs text-muted">{content.cto.escalationRateLabel}</p>
              <p className="mt-2 text-4xl font-semibold text-ink">{kpis.sensor_escalation_rate}%</p>
              <p className="mt-1 text-xs text-muted">{content.cto.sentPrefix}
                {Math.round(kpis.sensor_escalation_rate / 100 * kpis.open_ref * 2)}{content.cto.sentSuffix}
              </p>
            </div>
            <div className="border border-border bg-white p-6">
              <p className="text-xs text-muted">{content.cto.activeSuppliersLabel}</p>
        ...
        <Section className="bg-white">
          ...
          <h2 className="mt-4 text-2xl font-semibold tracking-tight text-ink">{content.cto.roiTitle}

          </h2>
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            <div className="border border-border bg-surface p-5 sm:p-8">
              <p className="text-sm font-semibold text-ink">{content.cto.hoursSavedLabel}</p>
              <p className="mt-4 text-4xl font-semibold text-ink sm:text-5xl">{kpis.engineering_hours_saved}h</p>
              <p className="mt-2 text-xs text-muted">{content.cto.basedOnPrefix}
            ...
            <div className="border border-border bg-surface p-5 sm:p-8">
              <p className="text-sm font-semibold text-ink">{content.cto.costSavedLabel}</p>
              <p className="mt-4 text-4xl font-semibold text-ink sm:text-5xl">
        ...
        <Section className="bg-surface">
          ...
          <h2 className="mt-4 text-2xl font-semibold tracking-tight text-ink">{content.cto.coverageTitle}
            ...
            <div
              ...
              key={item.surface}>
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-xs text-muted">{item.count}{content.cto.occurrenceSuffix}</p>
                </div>
        ...
        <Section className="bg-white">
          ...
          <h2 className="mt-4 text-2xl font-semibold tracking-tight text-ink">{content.cto.volumeTitle}
          ...
          <div className="mt-8 overflow-x-auto border border-border bg-surface p-4 sm:p-8">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-xs sm:gap-6">
        ...
        <Section className="bg-surface">
          ...
          <h2 className="mt-4 text-2xl font-semibold tracking-tight text-ink">{content.cto.actionsTitle}
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <button
              ...
              <p className="text-sm font-semibold text-ink">{content.cto.exportReportTitle}</p>
              <p className="mt-2 text-xs text-muted">{content.cto.exportReportDescription}
            ...
            <button
              ...
              <p className="text-sm font-semibold text-ink">{content.cto.reviewSafetyTitle}</p>
              <p className="mt-2 text-xs text-muted">{content.cto.reviewSafetyPrefix}
        ...
        <Section className="bg-white">
          <div className="border border-atlas-blue/25 bg-surface-blue p-5">
            <div className="flex items-start gap-3">
              <span className="mt-1 font-mono text-[10px] font-semibold text-atlas-blue">{content.cto.demoLabel}

              </span>
              <p className="text-xs leading-6 text-muted">{content.cto.demoDescription}
