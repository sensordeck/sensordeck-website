...
export default async function CompanyPage({
  ...
  return (
    <div className="bg-white">
        ...
        <AnimatedSection>
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:items-start lg:gap-20">
            ...
            <div className="border-y border-border py-8 md:py-10">
              ...
              <p className="mt-6 max-w-3xl text-body leading-8 text-muted">
                {mission.description}
              </p>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {mission.points.map((point, index) => (
                  <div key={point} className="border-t border-border pt-4">
                    ...
                    <p className="mt-3 text-label font-semibold leading-7 text-ink">
                      {point}
                    </p>
                  </div>
                ))}
      ...
      {/* Who we are */}
      <Section id="company-role" className="bg-surface">
        <AnimatedSection>
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:items-center lg:gap-20">
            ...
            <div className="border-l-2 border-sensor-tan bg-white p-6 md:p-8 lg:p-10">
              <p className="max-w-3xl text-card-title-lg font-medium leading-10 tracking-tight text-ink md:text-section-title-md">
                {category.lead}
              </p>
      ...
      <Section id="principles" className="bg-white">
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-3">
          {principles.map((principle, index) => (
            <Card
              className="stagger-item flex min-h-80 flex-col justify-between"
            ...
            >
              ...
              <span
                className="mt-8 block h-px w-10 bg-atlas-blue"
                aria-hidden="true"
              />
            </Card>
          ))}
      ...
      <Section id="boundaries" className="bg-surface">
        <div className="max-w-3xl">
          <p className="heading-eyebrow font-mono text-eyebrow font-semibold uppercase tracking-eyebrow text-atlas-blue">
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-2">
          {boundaries.map((boundary, index) => (
            <article
              className="stagger-item border border-border bg-white p-6 md:p-8"
              key={boundary.title}
            ...
            >
              ...
              <ul className="mt-6 grid gap-4">
                {boundary.items.map((item) => (
                  <li
                    className="flex items-start gap-3 text-label leading-7 text-muted"
                    key={item}
                  >
                    <span
      ...
      {/* Contact */}
      <Section id="company-contact" className="bg-white">
        <div className="border border-atlas-blue/25 bg-surface-blue p-7 md:p-10">
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <div
              className="stagger-item lg:justify-self-end"
              style={{ animationDelay: "240ms" }}
            >
              <Button
