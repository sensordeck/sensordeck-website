...
export default function HomePage() {
  return (
    <div className="flex min-h-full flex-1 flex-col bg-white">
      ...
      <main>
     <Section id="top" className="relative overflow-hidden bg-white min-h-[550px] lg:min-h-[700px]">
  ...
  {/* Overlay */}
<div className="absolute inset-0 flex items-start pt-12 sm:pt-24 lg:items-center lg:pt-0">
